      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-10 md:grid-cols-3">
          {examples.map((example) => <article key={example.id} className="min-w-0">
            <div className="relative aspect-video overflow-hidden rounded-lg border border-white/15 bg-neutral-900"><Image src={example.id === "launch" ? launchPreview : `/examples/${example.id}.png`} alt={example.title} fill sizes="(max-width: 768px) 100vw, 380px" className="object-contain" /></div>
