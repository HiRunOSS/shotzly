...
export type GraphicLayer = {kind: "rect" | "roundedRect" | "dashedRect" | "circle" | "arrow" | "emoji"; color: string; opacity: number; strokeWidth: number; filled: boolean; emoji: string};
